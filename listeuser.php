      ...
      <table id="example" class="table table-bordered" style="width:100%">
         ...
         <?php while($et=$stmt->fetch()){  ?>
                <tr  bgcolor="Silver">
                   ...
                   <td><a href="modifieruser.php?code=<?php echo($et['id']) ?>">Modifier</a></td>
                   <td><a onclick="return confirm('Voulez-vous supprimer..?');" href="supprimeruser.php?code=<?php echo($et['id']) ?>">Supprimer</a></td>
                </tr>
              <?php  } ?>
          </tbody>
          <tfoot>
