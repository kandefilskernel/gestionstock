  ...
  border-radius: 50%;
   ...
   <div class="col-md-12">
						<ul  class="menu">
                            ...
                            <li>
								<a href="dossieracademique.php"><?php echo $bienvenue?></a>
							</li>
                     <li>
								<a href="listeinscrits.php">Liste des etudiants inscrits</a>
							</li>
                    
							<li>
								<a href="dossieracademique.php">Verification</a>
							</li>
						</ul>
                  </div>
   ...
   <div>
   <center><h1 style="font-size: 12px;">LISTE DES ETUDIANTS PAR PROMOTION</h1></center><hr>
<center><button onclick="myFunction()">Imprimer</button></center>
      ...
      <table id="example" class="table table-bordered" style="width:100%">
         ...
         <?php while($et=$stmt->fetch()){  ?>
                <tr  bgcolor="Silver">
                   ...
                   <td><a href="dossier.php?code=<?php echo($et['idetudiant']) ?>">AJOUTER LE DOSSIER</a>
                   <td><a  href="photo.php?code=<?php echo($et['idetudiant']) ?>">AJOUTER PHOTO</a>  
                </tr>
              <?php  } ?>
          </tbody>
          <tfoot>
