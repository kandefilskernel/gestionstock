...
<center><section>
<form   method="get">
<div align="justify"> <input type="text" name="T" placeholder="SAISIR LA DATE"  size="30"/> <label for="T1">Choose Libellé:</label>
...
<select name="T1" id="cars" class="">
  ...
  <option value="Fiche d'avancement & proposition">Fiche d'avancement & proposition</option>
