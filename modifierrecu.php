...
-->
   ...
   <body onLoad="document.fo.login.focus()">
        ...
        <div class="col-md-12">
        <center><form  method="post"  action="Editerrecu.php" > 
        ...
        <fieldset>
           ...
           <tr>
               ...
               <input type="hidden"  name="id1"   value="<?php echo($etudiants['recu']) ?>"/>
           </tr>
            <tr>
               <td><label>Montant $:</label></td>
               <td><input type="text"  name="id2" class=""  value="<?php echo($etudiants['montant$']) ?>"/></td><hr>
            </tr>
            <tr>
              <td><label>CARNET:</label></td>
              <td><input type="text"  name="id3" class=""  value="<?php echo($etudiants['carnet']) ?>"/></td><hr>
            </tr>
            <tr>
               <td><label>DATE DE PAIEMENT:</label></td>
               <td><input type="text"  name="id4" class=""  value="<?php echo($etudiants['datepaiement']) ?>"/></td><hr> 
               
            </tr>
            <tr>
               <td><label>LIBELLE:</label></td>
               <td><input type="text"  name="id5" class=""  value="<?php echo($etudiants['libelle']) ?>" size="40"/></td><hr> 
