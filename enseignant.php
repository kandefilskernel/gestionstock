...
font-size: 10px;
   ...
   <ul class="menu">
							<li>
								<a href="#">Deconnexion(istam)</a>
                            </li>
                            <li>
								<a href="#">Gerer les dossiers</a>
							</li>
							
							<li>
								<a href="#">Créér enseignant</a>
							</li>
...
<center>
      ...
      <form  name="fo" method="post" action="" enctype="multipart/form-data">
         ...
         <input type="text" name="T"   size="40" placeholder="Saisir le nom complet"/>..<input type="text" name="T4"  size="40" placeholder="Saisir le Tél"/>..<input type="text" name="T5"  value="2020-2021"  size="10" class="form-control"/>..
         <div>
         ...
         <legend  style="color:red; background:black;">NIVEAU D'ETUDE</legend></br>
         <input  type="radio" name="T1" value="G1"/>LICENCIE
         <input type="radio" name="T1" value="G2"/>GRADUE
         <input type="radio" name="T1" value="G3"/>MASTER
         <input  type="radio" name="T1" value="L1"/>DOCTEUR
         </br></br>
