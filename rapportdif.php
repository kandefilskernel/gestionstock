...
<div>
						<ul class="menu">
                            ...
                            <li>
								<a href="dif.php">MENU</a>
                            </li>
                            <li>
								<a href="deconnexion.php"><?php echo $bienvenue?></a>
							</li>
...
<h1 style="font-size: 12px;">Etudiants en ordre</h1></center>
<center><h1 style="font-size: 10px;">Service de comptabilité istam</h1></center>
