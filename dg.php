...
$reponse->closeCursor();
?><input type="text" name="T1" placeholder="SAISIR LA DATE"  value="<?php
  //require_once("connexionBD.php");
   echo($date_titre=date('Y-m-d'));
...
<?php
  ...
  ?>
      ...
      <div align="right"><input type="text" name="T" placeholder="Saisir la date rélévé journalier validation"  size="30"  Value="<?php
  //require_once("connexionBD.php");
   echo($date_titre=date('Y-m-d'));
  ?>" align="right"/><button type="submit">CONFIRMER LE RELEVE</button>
</div>
</form>
</fieldset>
<fieldset ><center><section>
  <table id="example" class="display" style="width:100%">
		<thead>
			<tr><th>Nom</th><th>Promotion</th><th>Filiere</th><th>Montant</th><th>Libelle</th><th>Date</th><th>USER</th><th>Carnet</th><th>Etat</th></tr>
		</thead>
		<tbody>
			<?php
