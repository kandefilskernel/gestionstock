...
<?php
  ...
  require_once("cn.php");
  $sql="SELECT * FROM admin  ORDER BY nom ASC";
...
img {
  border-radius: 50%;
   ...
   <div class="container">
						<ul class="menu table table-bordered">
							<li>
                     ...
                     <li>
							...
							<li>
								<a href="useradmin.php">Creer mon compte</a>
							</li>
      ...
      <table id="example" class="table table-bordered" style="width:100%">
         ...
         <?php while($et=$stmt->fetch()){  ?>
                <tr  bgcolor="Silver">
                   ...
                   <td><a onclick="return confirm('Voulez-vous supprimer..?');" href="supprimeruadmin.php?code=<?php echo($et['id']) ?>">Supprimer</a>
                </tr>
              <?php  } ?>
          </tbody>
          <tfoot>
